...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description: "Smart categorization and urgency detection using advanced NLP algorithms",
  ...
  const stats = [
    { value: "2,500+", label: "Issues Resolved", icon: CheckCircle, color: "text-green-400" },
    { value: "15,000+", label: "Community Points", icon: Star, color: "text-yellow-400" },
    { value: "500+", label: "Active Reporters", icon: Users, color: "text-blue-400" },
    { value: "95%", label: "Satisfaction Rate", icon: Award, color: "text-purple-400" }
  ];

  const processSteps = [
    { number: "01", title: "Report Issue", description: "Submit complaints with photos and location", icon: MessageCircle },
    { number: "02", title: "AI Analysis", description: "Smart categorization and urgency detection", icon: Brain },
    { number: "03", title: "Authority Routing", description: "Automatic assignment to relevant department", icon: Zap },
    { number: "04", title: "Track & Resolve", description: "Real-time updates and status tracking", icon: Eye }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
          ...
          <AnimatedSection delay={0.6}>
            <p className="text-2xl lg:text-3xl text-blue-100 mb-12 max-w-4xl mx-auto leading-relaxed font-light">
              Transform community issues into <span className="font-semibold text-white">actionable solutions</span> with our intelligent 
              complaint management system powered by <span className="font-semibold text-yellow-300">artificial intelligence</span>.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="text-center mb-20">
              ...
              <p className="text-2xl text-gray-600 max-w-3xl mx-auto font-light">
                Simple steps to transform your community concerns into resolved issues
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <AnimatedSection>
            <div className="text-center mb-20">
              ...
              <p className="text-2xl text-gray-600 max-w-3xl mx-auto font-light">
                Everything you need for efficient and intelligent complaint management
              </p>
            </div>
          </AnimatedSection>
                  ...
                  <div className="relative">
                    ...
                    <div className="mb-6">
                      <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-lg border border-gray-200 group-hover:shadow-2xl transition-all duration-300">
                        <div className={`p-4 bg-gradient-to-br ${feature.color} rounded-xl text-white transform group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <h2 className="text-5xl lg:text-7xl font-black text-white mb-8">
              Ready to Make a <span className="bg-gradient-to-r from-yellow-300 to-pink-400 bg-clip-text text-transparent">Difference</span>?
            </h2>
          </AnimatedSection>

          <AnimatedSection delay={0.3}>
            <p className="text-2xl text-blue-100 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
              Join thousands of proactive citizens who are already transforming their communities through CivicSense.
            </p>
          </AnimatedSection>
