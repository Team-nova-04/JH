...
import { Filter, Search, Shield, AlertTriangle, Users, Target, Building2 } from 'lucide-react';
...
const AuthorityComplaints = () => {
  ...
  const fetchComplaints = async () => {
    try {
      ...
      const urgentComplaints = (res.data.data.complaints || []).filter(
      ...
      <div className="relative z-10 mx-auto space-y-8 max-w-7xl">
        ...
        <div className="text-center" data-aos="fade-down" data-aos-delay="200">
          ...
          <p className="max-w-3xl mx-auto text-2xl leading-relaxed text-gray-700">
            Manage complaints assigned to your authority ({total} total)
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-4" data-aos="fade-up" data-aos-delay="300">
          ...
          <div className="bg-gradient-to-r from-[#059669] to-[#10B981] rounded-3xl shadow-2xl p-6 text-white text-center group hover:scale-105 transition-transform duration-300">
            <Shield className="h-8 w-8 mx-auto mb-3 text-[#FFBE29] group-hover:scale-110 transition-transform duration-300" />
            <div className="mb-1 text-2xl font-bold">{urgentCount}</div>
            <div className="text-sm font-semibold text-white/90">Urgent Cases</div>
          </div>
        </div>

        {/* Filters - Categories removed, now 3 filters */}
        <div 
        ...
        >
          <div className="flex items-center mb-6 space-x-3">
            ...
            <span className="text-2xl font-bold text-gray-800">Filter Complaints</span>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6" data-aos="fade-up" data-aos-delay="500">
            {complaints.map((complaint, index) => (
              ...
              >
                ...
                <div className="relative">
                  <ComplaintCard complaint={complaint} showActions={true} onStatusChange={handleStatusChange} />
