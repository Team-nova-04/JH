...
import { Shield, Mail, Lock, AlertCircle, Building2 } from 'lucide-react';
...
const AuthorityLogin = () => {
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    const result = await authorityLogin(data.email, data.password);
    setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FEF3C7] via-[#FDE68A] to-[#FCD34D] flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background Elements */}
      ...
      >
        ...
        <div className="text-center" data-aos="fade-down" data-aos-delay="300">
          ...
          <p className="mt-3 text-lg font-medium text-gray-700">
            Government Authority Access Gateway
          </p>
        </div>
        ...
        >
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-gray-700">
              <p className="font-semibold text-[#00534E]">Official Access Only</p>
              <p>This portal is reserved for authorized government authorities. Unauthorized access is prohibited.</p>
            </div>
          </div>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="authority@government.lk"
                  />
                </div>
              </div>
              {errors.email && (
          ...
          <div 
            ...
            data-aos-delay="800"
          >
            <p className="mb-3 text-sm font-semibold text-gray-700">Authority Capabilities:</p>
            <div className="grid grid-cols-2 gap-3 text-xs text-gray-600">
              ...
              <div className="flex items-center space-x-2">
                <Building2 className="h-3 w-3 text-[#00534E]" />
        ...
        {/* Footer Note */}
        <div className="pt-4 text-center border-t border-white/40" data-aos="fade-up" data-aos-delay="900">
          <p className="text-xs text-gray-600">
            For support, contact the <span className="font-semibold text-[#00534E]">Government IT Department</span>
          </p>
        </div>
      </div>
