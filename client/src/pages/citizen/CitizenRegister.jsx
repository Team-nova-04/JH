    ...
    <div className="min-h-screen mt-[-20px] bg-gradient-to-br from-[#FEF3C7] via-[#FDE68A] to-[#FCD34D] flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="mt-[-20px] space-y-5">
            ...
            <div data-aos="fade-right" data-aos-delay="400">
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#8D153A]" />
                  <input
                    {...register('name')}
                    type="text"
            ...
            <div data-aos="fade-left" data-aos-delay="700">
              ...
              <div className="relative group">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-[#FDE68A] to-[#FCD34D] rounded-lg blur opacity-30 group-hover:opacity-40 transition duration-300"></div>
                <div className="relative">
                  <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#8D153A]" />
                  <input
                    {...register('phone')}
                    type="tel"
          ...
          {/* Benefits Section */}
          <div className="p-4 border bg-white/40 rounded-2xl border-white/60" data-aos="fade-up" data-aos-delay="800">
            <p className="mb-2 text-sm font-semibold text-gray-700">Benefits of registering:</p>
            <ul className="space-y-1 text-xs text-gray-600">
              <li className="flex items-center space-x-2">
                <CheckCircle className="h-3 w-3 text-[#8D153A]" />
                <span>Track all your complaints in one place</span>
              </li>
              <li className="flex items-center space-x-2">
                <CheckCircle className="h-3 w-3 text-[#8D153A]" />
              ...
              <li className="flex items-center space-x-2">
                <CheckCircle className="h-3 w-3 text-[#8D153A]" />
                <span>Join local community discussions</span>
              </li>
            </ul>
          </div>
