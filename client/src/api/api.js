...
export const authorityAPI = {
  ...
  getComplaints: (params) => axiosClient.get('/authority/complaints', { params }),
  getComplaintById: (id) => axiosClient.get(`/authority/complaints/${id}`),
  updateStatus: (id, status) => axiosClient.patch(`/authority/complaints/${id}/status`, { status }),
  addNote: (id, content) => axiosClient.post(`/authority/complaints/${id}/notes`, { content }),
  requestContact: (id) => axiosClient.post(`/authority/complaints/${id}/request-contact`),
};

// ============ Admin APIs ============
export const adminAPI = {
  login: (data) => axiosClient.post('/admin/login', data),
  createAuthorityUser: (data) => axiosClient.post('/admin/authority-users', data),
  getAllComplaints: (params) => axiosClient.get('/admin/complaints', { params }),
  uploadCSV: (file) => {
